...
RcppExport SEXP _eseisLite_stalta_event_freeze(SEXP event_lengthSEXP, SEXP data_staSEXP, SEXP data_ltaSEXP, SEXP onSEXP, SEXP offSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _eseisLite_stalta_event_nofreeze(SEXP event_lengthSEXP, SEXP ratioSEXP, SEXP onSEXP, SEXP offSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type event_length(event_lengthSEXP);
